...
with cola:
    st.image("data/red_rose.jpeg", width=205, height=205)
    st.image("data/green_grass.jpeg", width=205, height=205)
with colb:
    st.image("data/pink_donut.jpeg", width=205, height=205)
    st.image("data/orange_nature.jpeg", width=205, height=205)
with colc:
    st.image("data/blue_ocean.jpeg", width=205, height=205)
    st.image("data/yellow_sun.jpeg", width=205, height=205)